...
public interface ISegmentService
{
    ...
    public Task<bool> AddSomeUsersForSegment(Guid segmentId, List<Guid> vkUserIds);
    ...
    public Task<bool> DeleteSomeUsersFromSegment(Guid segmentId, List<Guid> vkUserIds);
